...
> In DaBNet we created cross-platform application. Developed back-end of Needion project.

**SERVICE STACK (WITH .NET) :**

It provided Restful service architecture and it also has a client service generator for different programming languages.

**NODEJS WITH SOCKET.IO :**

Wrote chat application for clients messaging with each others. Used ECMAScript 6 standards with Node.js 10 and Socket.IO 2.0
Also use Redis with ServiceStack for some caching data and distribute tokens. Mongo db for chat sessions and client logs.
